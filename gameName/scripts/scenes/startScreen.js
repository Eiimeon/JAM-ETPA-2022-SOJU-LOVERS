class StartScreen extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('controls', 'assets/images/protoControls.png');
        this.load.image('resume', 'assets/images/protoResume.png');
        this.load.image('mainMenu', 'assets/images/protoMainMenu.png');
        this.load.image('controlsMenu', 'assets/images/protoControlsMenu.png');
        this.load.image('goBack', 'assets/images/protoGoBack.png');
